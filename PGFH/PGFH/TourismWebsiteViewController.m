//
//  TourismWebsiteViewController.m
//  PGFH
//
...
@interface TourismWebsiteViewController ()

@end

@implementation TourismWebsiteViewController
@synthesize backBtn,userSearchBar,searchBtn,categoriesBtn,postBtn,webView,mvc,strURL,logoimg;
...
- (void)viewDidLoad {
    ...
    if([strURL isEqualToString:@""] || strURL ==nil)
        strURL=[[NSString alloc] initWithString:@"http://www.tourism.gov.my/fr-fr/fr"];
    ...
    TourismWebsiteViewController *torvc;
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
    {
        torvc=[[TourismWebsiteViewController alloc] initWithNibName:@"TourismWebsiteViewController~ipad" bundle:nil];
    ...
    if(height>=480 && height<568){
        ...
        backBtn.layer.frame=CGRectMake(5,23,30,30);
