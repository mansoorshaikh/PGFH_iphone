...
-(UIView *)changePassAlert{
    ...
    UITextField *ChangePass;
    ChangePass=[[UITextField alloc] initWithFrame:CGRectMake(0,0, 300,48)];
    ...
    UIButton *upDateBtn,*cancelBtn;
    upDateBtn=[[UIButton alloc] initWithFrame:CGRectMake(0,50,150,50)];
    ...
    cancelBtn=[[UIButton alloc] initWithFrame:CGRectMake(150,50,150,50)];
